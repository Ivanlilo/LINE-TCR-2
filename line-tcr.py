...
cl = LINETCR.LINE()
cl.login(token='El5O4MCg3pAYNbWuMfze.oZvhUAFgHByBYZrU8oH1lG.k6Q4k1719KDvk9BBMEHkCPPR8fPeOQwXwzSkNzRLNjk=')
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token='ElMpJsHUprC2Riedriie.fSlSQWESgj8lt2xWExfzlG.z9iqUfy/x8c6CTxZLJx8M6JjDHiVy11DFbsRvqcf5BQ=')
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token='ElqX2j1f17t4SLCR9C32.bTIOm6rxk1dRZNcsZniO8G.s/Wo3Q3IIVHwvGDcoN7N1kVxNNMvTdVRyII2SFQ4Pa0=')
kk.loginResult()
...
Bots=[mid,Amid,Bmid]
admin=['u3b3547b9a7c685b61bcb346ef0e8752e','u16c2ecab07ac189f0b4f65f07971592e']
wait = {
    'contact':True,
    'autoJoin':True,
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if msg.from_ in admin:
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'u3b3547b9a7c685b61bcb346ef0e8752e'}
                    cl.sendMessage(msg)
